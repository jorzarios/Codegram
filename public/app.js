...
var _templateObject = _taggedTemplateLiteral(['\n  <footer class="site-footer">\n    <div class="container">\n      <div class="row">\n        <div class="col s12 l3 center-align"><a href="#" class="dropdown-button btn btn-flat" data-activates="dropdown1">', '</a>\n          <ul id="dropdown1" class="dropdown-content">\n            <li><a href="#" class="idioma" onclick=', '>', '</a></li>\n            <li><a href="#" class="idioma" onclick=', '>', '</a></li>\n          </ul>\n        </div>\n        <div class="col s12 l3 push-l6 center-align">2016 Codegram\u2122</div>\n      </div>\n    </div>\n  </footer>'], ['\n  <footer class="site-footer">\n    <div class="container">\n      <div class="row">\n        <div class="col s12 l3 center-align"><a href="#" class="dropdown-button btn btn-flat" data-activates="dropdown1">', '</a>\n          <ul id="dropdown1" class="dropdown-content">\n            <li><a href="#" class="idioma" onclick=', '>', '</a></li>\n            <li><a href="#" class="idioma" onclick=', '>', '</a></li>\n          </ul>\n        </div>\n        <div class="col s12 l3 push-l6 center-align">2016 Codegram\u2122</div>\n      </div>\n    </div>\n  </footer>']);
...
var _templateObject = _taggedTemplateLiteral(['\n<nav class="header">\n    <div class="nav-wrapper">\n      <div class="container">\n        <div class="row">\n          <div class="col s6 m6 offset-m1">\n            <a href="/" class="brand-logo platzigram">Codegram</a>\n          </div>\n          <div class="col s3 m3 push-s3 push-m3">\n            <a href="#" class="btn btn-large btn-flat dropdown-button" data-activates="drop-user">\n              <i class="fa fa-user-circle-o" aria-hidden="true"></i>\n            </a>\n            <ul id="drop-user" class="dropdown-content">\n              <li><a href="#">', '</a></li>\n            </ul>\n          </div>\n        </div>\n      </div>\n    </div>\n</nav>'], ['\n<nav class="header">\n    <div class="nav-wrapper">\n      <div class="container">\n        <div class="row">\n          <div class="col s6 m6 offset-m1">\n            <a href="/" class="brand-logo platzigram">Codegram</a>\n          </div>\n          <div class="col s3 m3 push-s3 push-m3">\n            <a href="#" class="btn btn-large btn-flat dropdown-button" data-activates="drop-user">\n              <i class="fa fa-user-circle-o" aria-hidden="true"></i>\n            </a>\n            <ul id="drop-user" class="dropdown-content">\n              <li><a href="#">', '</a></li>\n            </ul>\n          </div>\n        </div>\n      </div>\n    </div>\n</nav>']);
...
var _templateObject = _taggedTemplateLiteral(['<div class="progress container"><div class="indeterminate"></div></div>'], ['<div class="progress container"><div class="indeterminate"></div></div>']);
          ...
          uploadButton.click(function () {
            var pic = {
              ...
              user: {
                ...
                avatar: 'https://scontent.fmex5-1.fna.fbcdn.net/v/t1.0-9/15542341_10154859957058675_8383774734883043065_n.jpg?oh=4895f5c0886b9e4a459774305ecc0be0&oe=59BB1F97'
              }
            };
...
function loadPictures(ctx, next) {
  var main = document.getElementById('main-container');
  var $loader = yo(_templateObject);
  empty(main).appendChild($loader);
  request.get('/api/pictures').withCredentials().end(function (err, res) {
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    ...
    var template = yo(_templateObject, picture.liked ? 'liked' : '', picture.url, like.bind(null, null, true), picture.likedHeart ? 'liked' : '', picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.message('likes', { likes: picture.likes }));
    return template;
  }
...
},{"../landing":348,"../layout":349,"../translate":357,"yo-yo":341}],353:[function(require,module,exports){
'use strict';
...
var _templateObject = _taggedTemplateLiteral(['<div class="col s12 m6">\n    <div class="row">\n      <div class="signup-box">\n        <h1 class="platzigram">Codegram</h1>\n        <form class="signup-form">\n          <h2>', '</h2>\n          <div class="section">\n            <a class="btn btn-fb hide-on-med-and-down">', '</a>\n            <a class="btn btn-fb hide-on-large-only"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>\n          </div>\n          <div class="divider"></div>\n          <div class="section">\n            <input type="email" name="email" placeholder="', '">\n            <input type="text" name="name" placeholder="', '">\n            <input type="text" name="username" placeholder="', '">\n            <input type="password" name="password" placeholder="', '">\n            <a class="btn waves-effect waves-light btn-signup">', '</a>\n          </div>\n        </form>\n      </div>\n    </div>\n    <div class="row">\n      <div class="login-box">\n          \xBFTienes una cuenta? <a href="/signin">', '</a>\n      </div>\n    </div>\n  </div>'], ['<div class="col s12 m6">\n    <div class="row">\n      <div class="signup-box">\n        <h1 class="platzigram">Codegram</h1>\n        <form class="signup-form">\n          <h2>', '</h2>\n          <div class="section">\n            <a class="btn btn-fb hide-on-med-and-down">', '</a>\n            <a class="btn btn-fb hide-on-large-only"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>\n          </div>\n          <div class="divider"></div>\n          <div class="section">\n            <input type="email" name="email" placeholder="', '">\n            <input type="text" name="name" placeholder="', '">\n            <input type="text" name="username" placeholder="', '">\n            <input type="password" name="password" placeholder="', '">\n            <a class="btn waves-effect waves-light btn-signup">', '</a>\n          </div>\n        </form>\n      </div>\n    </div>\n    <div class="row">\n      <div class="login-box">\n          \xBFTienes una cuenta? <a href="/signin">', '</a>\n      </div>\n    </div>\n  </div>']);
...
var signUpForm = yo(_templateObject, translate.message('signup.subheading'), translate.message('signup.facebook'), translate.message('email'), translate.message('fullname'), translate.message('username'), translate.message('password'), translate.message('signup.call-to-action'), translate.message('signin'));
var $landing = landing(signUpForm);
module.exports = layout($landing);

},{"../landing":348,"../layout":349,"../translate":357,"yo-yo":341}],355:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  'signup.facebook': 'Inicia con Facebook',
...
function loadUser(ctx, next) {
  request.get('/api/user/' + ctx.params.username).withCredentials().end(function (err, res) {
    if (err) return console.log(err);
...
},{"../header":344,"./template":359,"empty-element":299,"page":328,"superagent":332,"title":339}],359:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['\n  <div class="container user-page">\n    <div class="row">\n      <div class="col s12 m10 offset-m1 l3 offset-l3 center">\n        <img src="', '" alt="Avatar" class="avatar responsive-img">\n      </div>\n      <div class="col s12 m10 offset-m1 l6 left-align">\n        <h1 class="username center-align">@', '</h1>\n        <p class="userDescription center-align">', '</p>\n      </div>\n    </div>\n    <div class="divider division"></div>\n    <div class="user-pictures">\n      <div class="row">\n        ', '\n      </div>\n    </div>\n  </div>'], ['\n  <div class="container user-page">\n    <div class="row">\n      <div class="col s12 m10 offset-m1 l3 offset-l3 center">\n        <img src="', '" alt="Avatar" class="avatar responsive-img">\n      </div>\n      <div class="col s12 m10 offset-m1 l6 left-align">\n        <h1 class="username center-align">@', '</h1>\n        <p class="userDescription center-align">', '</p>\n      </div>\n    </div>\n    <div class="divider division"></div>\n    <div class="user-pictures">\n      <div class="row">\n        ', '\n      </div>\n    </div>\n  </div>']),
    _templateObject2 = _taggedTemplateLiteral(['\n          <div class="col s12 m4">\n            <a href="/', '/', '">\n              <div class="user-pic">\n              <img src="', '" alt="" class="responsive-img">\n              <div class="overlay">\n                <div class="likes">\n                  <i class="fa fa-heart" aria-hidden="true"></i> ', '\n                </div>\n              </div>\n              </div>\n            </a>\n            <div id="modal', '" class="modal modal-fixed-footer">\n              <div class="modal-content">\n                <img src ="', '"/>\n              </div>\n              <div class="modal-footer">\n                <div class="btn btn-flat"><i class="fa fa-heart" aria-hidden="true"></i> ', '</div>\n              </div>\n            </div>\n          </div>'], ['\n          <div class="col s12 m4">\n            <a href="/', '/', '">\n              <div class="user-pic">\n              <img src="', '" alt="" class="responsive-img">\n              <div class="overlay">\n                <div class="likes">\n                  <i class="fa fa-heart" aria-hidden="true"></i> ', '\n                </div>\n              </div>\n              </div>\n            </a>\n            <div id="modal', '" class="modal modal-fixed-footer">\n              <div class="modal-content">\n                <img src ="', '"/>\n              </div>\n              <div class="modal-footer">\n                <div class="btn btn-flat"><i class="fa fa-heart" aria-hidden="true"></i> ', '</div>\n              </div>\n            </div>\n          </div>']);
...
module.exports = function (user) {
  return (0, _yoYo2.default)(_templateObject, user.avatar, user.username, user.userdesc, user.pictures.map(function (pic) {
    return (0, _yoYo2.default)(_templateObject2, user.username, pic.id, pic.url, _translate2.default.message('likes', { likes: pic.likes }), pic.id, pic.url, _translate2.default.message('likes', { likes: pic.likes }));
  }));
};

},{"../translate":357,"yo-yo":341}]},{},[347]);
